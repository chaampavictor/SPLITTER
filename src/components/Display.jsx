const Display = ({ calculatedTip, total, people, handleReset }) => {
    ...
    return (
      <div className="display">
        ...
        {
          total ? (<button className="btn" onClick={handleReset}>Reset</button>) : (<button className="btn" disabled>Reset</button>)
        }
      </div>
    )
  }
